...
export default function Navbar() {
    ...
    return (
        <div className='fixed top-0 left-0 right-0 z-50 py-3 sm:py-4'>
            <div className='max-w-6xl mx-auto px-4 sm:px-6 py-2 sm:py-3 flex justify-between items-center backdrop-blur-[20px] bg-black/10 border border-gray-200 rounded-full shadow-md transition-all duration-300'>
                <div
                    onClick={scrollToTop}
