            ...
            <section className="py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="summary-grid grid md:grid-cols-2 gap-10">
                        ...
                        <div className="problem-statement bg-white p-8 rounded-xl shadow-[0_0_20px_4px_rgba(0,0,0,0.2)] border-l-4 border-red-500">
                        ...
                        <div className="solution-statement bg-white p-8 rounded-xl shadow-[0_0_20px_4px_rgba(0,0,0,0.2)] border-l-4 border-green-500">
