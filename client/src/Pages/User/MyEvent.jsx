...
const getStatusBorderClass = (status) => {
    switch (status) {
        ...
        case 'Registered':
            // Bright blue for active/future events
...
export default function MyEvent() {
    ...
    function fetchRegisteredEvents() {
        axiosInstance({
            ...
            .then((res) => {
                registeredEvents(res?.data?.data)
            })
            .catch((err) => {
                console.log('err :>> ', err);
            })
    ...
    useEffect(() => {
        // Using a constant for the data, placed inside useEffect to avoid unnecessary re-creation
        const eventData = dummyRegisteredEvents;

        const t = setTimeout(() => {
            setRegisteredEvents(eventData);
            // setIsLoading(false);
        }, 1000);
    ...
    if (isLoading) {
        return (
            <div className="min-h-[60vh] flex justify-center items-center gap-5">
